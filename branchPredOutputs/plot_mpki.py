...
## This script expects a simulation output filename as its argument
## e.g. plot_mkpi.py blackscholes.bp.out
import sys
import matplotlib
matplotlib.use('Agg')
...
## For nbit predictors
predictors_to_plot = [ "  Nbit-8K-2", "  Nbit-16K-1", "  NonT", "  Gshare", "  BTFNT"]
	...
	if line.startswith("Total Instructions:"):
		...
		for pred_prefix in predictors_to_plot:
			if line.startswith(pred_prefix):
                # Assumes the format   PREDICTOR_NAME':' "Correct:" NUMBER "Incorrect:" NUMBER
                # The 2 spaces at the start of the predictor name are important!!!!
