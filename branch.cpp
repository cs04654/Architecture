...
VOID InitPredictors()
{
    ...
    ///////////////////////////////////////////////
    NotTakenPredictor *testNonT = new NotTakenPredictor();
    branch_predictors.push_back(testNonT);
    ///////////////////////////////////////////////////////////////
    BTFNT_BranchPredictor *testBTFNT = new BTFNT_BranchPredictor();
    branch_predictors.push_back(testBTFNT);
    //////////////////////////////////////////////////////////////////
    Gshare *testGshare = new Gshare(2, 13, 8);
    branch_predictors.push_back(testGshare);
    //////////////////////////////////////////////////////////////////
    //BTB has doesnt work
